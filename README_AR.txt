...
Cart/Menu Fix:
- زر السلة يفتح السلة الجانبية على الصفحة الرئيسية بدل الانتقال لقسم المنتجات.
- تمت إضافة عداد السلة داخل النافبار.
- تم تحسين منيو الموبايل لتفتح مباشرة تحت زر الهامبورجر بشكل Glass احترافي.
- تم تحديث كاش Service Worker لإجبار ظهور النسخة الجديدة.


InstaPay Update:
- تم إضافة خيار الدفع الفوري عبر InstaPay داخل السلة.
- رقم استقبال التحويل: 01033298722.
- يتم نسخ الرقم من نافذة الدفع وإرسال الطلب عبر واتساب بعد التحويل.
- ملاحظة: يجب أن يكون الرقم مفعلًا ومربوطًا بحساب InstaPay من جانب صاحب التطبيق/الحساب.


InstaPay Direct Link Update:
- تم تحديث زر الدفع ليفتح رابط InstaPay المباشر المرسل من التاجر.
- الرابط المستخدم: https://ipn.eg/S/mohamedemam9797/instapay/9FmpEn
- يتم نسخ المبلغ وبيانات الطلب قبل فتح رابط الدفع.
